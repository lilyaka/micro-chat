...
class GroupRoleService(
    ...
    fun promoteToAdmin(groupId: String, targetUserId: String): RoleChangeResponse {
        val userId = webUtil.getUserId()
        val group = groupService.getGroup(groupId)
            ?: throw GroupException("groupNotFound", "Group not found")
    ...
    fun demoteFromAdmin(groupId: String, targetUserId: String): RoleChangeResponse {
        val userId = webUtil.getUserId()
        val group = groupService.getGroup(groupId)
            ?: throw GroupException("groupNotFound", "Group not found")
    ...
    fun transferOwnership(groupId: String, targetUserId: String): RoleChangeResponse {
        val userId = webUtil.getUserId()
        val group = groupService.getGroup(groupId)
            ?: throw GroupException("groupNotFound", "Group not found")
